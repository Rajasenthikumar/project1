        ...
        <Grid container item spacing={3}>
          <Grid item xs={4}>
            <FormControl variant="standard" error={errors.contactNumber}>
              ...
              />
              {errors.contactNumber && <span className='errormessage'>Please enter a valid number.</span>}
            </FormControl>
          </Grid>
          ...
          <Grid item xs={4}>
            <FormControl variant="standard" error={errors.pinCode}>
              ...
              />
              {errors.pinCode && <span className='errormessage'>Please enter a  valid Pin Code.</span>}
            </FormControl>
          </Grid>
        </Grid>
        <Grid container item spacing={3}>
